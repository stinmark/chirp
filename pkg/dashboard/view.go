...
func (m dashboardModel) View() tea.View {
	...
	segments = append(segments, lipgloss.NewStyle().Foreground(lipgloss.Color("12")).Render(bannerText))
	statusLine := fmt.Sprintf(
		"daemon %s\n",
		lipgloss.NewStyle().Foreground(lipgloss.Color("5")).Render(helpers.Ternary(m.daemonRunning, "RUNNING", "STOPPED")),
	)
